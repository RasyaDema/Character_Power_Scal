...
public class CharacterListUI extends JFrame {
    ...
    private JPanel createNavbar() {
        ...
        JLabel title = new JLabel("  Character Anime");
    ...
    private JScrollPane createCharacterGrid() {
        ...
        for (Character character : characters) {
            ...
            card.setPreferredSize(new Dimension(200, 180)); // Ukuran tetap untuk konsistensi
    
            JLabel imageLabel = new JLabel();
            imageLabel.setHorizontalAlignment(SwingConstants.CENTER);
            imageLabel.setIcon(new ImageIcon(character.image.getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH)));
    
            JLabel nameLabel = new JLabel(character.name, SwingConstants.CENTER);
            nameLabel.setFont(new Font("SansSerif", Font.PLAIN, 14));
    
            // Tambahkan interaksi klik karakter
        ...
        // ScrollPane tetap fleksibel terhadap tinggi konten
    ...
    private List<Character> generateCharacters() {
        ...
        // Daftar nama karakter sesuai keinginan kamu
        String[] names = {
        ...
        for (int i = 0; i < names.length; i++) {
            String imagePath = "src/images/character" + (i + 1) + ".jpg"; // Path sesuai
